    ...
    <div className="container px-5 py-24 mx-auto">
      ...
      {/**Image*/}
        ...
        <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
          ...
          {/**Heading*/}
          <h1 className="scroll-m-20 text-2xl font-semibold tracking-tight text-myblack">
          ...
          {/**paragraph*/}
          <p className="leading-relaxed text-myblack/80 scroll-m-20 text-base font-normal text-myblack">
          This t-shirt combines comfort and style effortlessly, perfect for casual outings or relaxing at home, crafted with premium fabrics for lasting wear, and designed to make you feel confident and trendy every time you wear it
          </p>
          ...
          <div className="flex items-center justify-between">
            ...
            <Button className='scroll-m-20 pb-2 text-xs font-semibold
          ...
          {/**Button*/}        
          <Button className='mt-4 w-full scroll-m-20 pb-2 text-xs font-semibold
            tracking-tight first:mt-0 bg-myblack text-white hover:bg-transparent hover:text-myblack'>
