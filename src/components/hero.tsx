         ...
         <div className="hero-content text-neutral-content text-center">
          <div className="max-w-md">
            <h1 className="mb-5 scroll-m-20 text-4xl font-extrabold
             tracking-tight lg:text-5xl">Trendy <span className='text-[#4B70F5]'>Looks</span></h1>
            ...
            Shop our exclusive selection and elevate your style with chic and comfortable outfits
                ...
                <Button className='outline outline-offset-2 outline-2 group hover:outline-myblue duration-300'>
                    <AiFillShopping className="group-hover:text-myblue group-hover:animate-bounce duration-300"/> Shop Now
                </Button>
          </div>
        </div>
      </div>
